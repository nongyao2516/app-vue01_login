    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        <tr v-for="product in products" :key="product.product_id">
          ...
          <td>{{ product.stock }}</td>
          <td>
            <img v-if="product.image" :src="'http://localhost/app-vue01/php_api/uploads/' + product.image"
              width="100" />
          </td>
          <td>
            ...
            <form @submit.prevent="saveProduct">
              ...
              <div class="mb-3">
                ...
                <div v-if="isEditMode && editForm.image">
                  ...
                  <img :src="'http://localhost/app-vue01/php_api/uploads/' + editForm.image" width="100" />
                </div>
              </div>
