        ...
        <tr v-for="employee in employees" :key="employee.emp_id">
          ...
          <td>
            <img
              v-if="employee.image"
              :src="
                'http://localhost/app-vue01/php_api/uploads/' + employee.image
              "
              width="100"
            />
          </td>
          ...
          <div class="modal-body">
            <form @submit.prevent="saveEmployee">
              ...
              <div class="mb-3">
                ...
                <select class="form-select" v-model="editForm.department" required>
              ...
              <div class="mb-3">
                ...
                <select class="form-select" v-model="editForm.active" required>
